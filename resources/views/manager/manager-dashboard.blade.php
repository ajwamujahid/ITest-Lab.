                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        @if(Auth::guard('manager')->check())
                            @php
                                ...
                                $departmentData = \App\Models\Department::where('manager_id', $manager->id)->first();
                                $role = $departmentData->name ?? 'N/A';
                                $department = $departmentData->description ?? 'N/A';
                            @endphp
                        ...
                        @else
                            <div class="alert alert-warning">No manager logged in.</div>
                        @endif
